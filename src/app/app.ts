...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, Footer, Navbar, BasicInfoComponent, SearchResultsComponent, ReportFormComponent, ConfirmationComponent, PricingPageComponent, ReviewsPageComponent, PlumberList, Search, Home],
